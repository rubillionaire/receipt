...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'receipt_weather', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('temp_f', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=1)),
            ('temp_c', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=1)),
            ('temp_str', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'receipt', ['Weather'])


    def backwards(self, orm):
        # Deleting model 'Weather'
        db.delete_table(u'receipt_weather')
    ...
    models = {
        ...
        u'receipt.weather': {
            ...
            'temp_str': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
